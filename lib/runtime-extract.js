 ...
 *   <exe-dir>/icon.ico
 *
 * Note: claude-agent-sdk, systray2, vendor/ and traybin/ are NOT embedded in the
 * pkg snapshot (too large / contain platform binaries). They are copied as companion
 * files by post-pkg.js and must be distributed alongside the exe.
 */
...
function extractRuntime() {
  ...
  // --- 3. icon.ico (may be embedded via pkg.assets or already next to exe) ---
