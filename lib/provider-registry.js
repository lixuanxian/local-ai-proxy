...
function createDefaultRegistry() {
  ...
  // IMPORTANT: Use static string literals in require() so esbuild/pkg can resolve them.
  // Dynamic require(variable) cannot be statically analyzed and will fail in bundled builds.
  const builtins = {
